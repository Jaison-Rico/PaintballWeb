...
export default function Footer() {
  return (
    <div>
      ...
      <footer>
        <div className="container-fluid " style={{backgroundColor: "#EFF2D8"}}>
            ...
            <div className="col-md-6 col-xs-12 col-lg-4 ">
              ...
              <div>
                <p className="text-secondary pb-2">
                  Paintball Medellín ofrece experiencias de paintball llenas de
                  adrenalina en escenarios estratégicos. Diversión segura para
                  amigos, empresas y eventos.
                </p>
              </div>
            </div>
            <div className="col-md-6 col-xs-12 col-lg-4">
